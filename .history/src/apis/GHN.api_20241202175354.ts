...
export const getStatusOrderGHNByCodeOrder = (data: any) => http.post('/v2/shipping-order/detail', data)

export const cancelOrderGHNByCodeOrder = (codeOrder: string) =>
  http.post('/v2/switch-status/cancel', { order_codes: [codeOrder] })
