...
export const getRoleAuth = () => http.get('/auth/user-info')
export const restorePass = (id: number, password: string) =>
  http.put(`/admin/reset-password?id=${id}&password=${password}`)
