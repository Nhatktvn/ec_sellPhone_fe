...
export const createOrderGHN = (data: FormData, totalPrice: number | undefined) =>
  http.post(`/payment/pay?totalPrice=${totalPrice}`, data, {
    headers: {
      'Content-Type': 'multipart/form-data'
    }
...
export const updateStatusOrderByAdmin = (data: any) => http.put('/admin/order/update-status', data)
