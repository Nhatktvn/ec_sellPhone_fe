...
import { sendCodeActive } from '../../apis/auth.api'
...
const ConfirmActive = () => {
  ...
  const handleSendCodeActive = async () => {
    try {
      dispatch(loading(true))
      const rsSendCode = await sendCodeActive(emailActiveAccount)
  ...
  return (
    <div className='flex items-center justify-center bg-orange'>
      <div className='bg-white py-5 px-20 my-20 shadow-md relative'>
        ...
        <h3 className='text-xl text-center'>Tài khoản chưa được kích hoạt</h3>
        <button
