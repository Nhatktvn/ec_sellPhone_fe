...
const ProductDetail = () => {
  ...
  return (
    <>
      {product ? (
        <div className='h-10 w-10'>
          <span className='animate-spin h-full w-full block border-[10px] border-l-transparent rounded-full border-spacing-2 border-gray-500 z-10'></span>
        </div>
      ) : (
        <div></div>
      )}
    ...
    //   <div className='my-4 p-4 grid grid-cols-12 bg-white rounded-xl'>
