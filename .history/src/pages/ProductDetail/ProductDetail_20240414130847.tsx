  ...
  return (
    <div className='container'>
      ...
      <div className='grid grid-cols-12 gap-3'>
        <div className='col-span-9 rounded-xl bg-white p-2 text-orange text-lg font-semibold'>Thông tin chi tiết</div>
        <div className='col-span-3 rounded-xl bg-white p-2 text-lg font-semibold'>Thông số kỹ thuật</div>
      </div>
    </div>
  )
}
