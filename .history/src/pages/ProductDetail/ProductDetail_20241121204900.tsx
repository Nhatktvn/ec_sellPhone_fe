        ...
        <div className='container'>
          ...
          <div className='grid grid-cols-12 gap-3'>
            <div className='col-span-7 bg-white'>
              <div className='w-full flex gap-10 justify-center mx-4'>
                <button className='py-3 px-6 border font-bold border-gray-300 rounded-md'>Thông số kỹ thuật</button>
                <button>Bài viết đánh giá</button>
              </div>
            </div>
            <div
