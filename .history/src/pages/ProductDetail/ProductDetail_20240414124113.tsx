      ...
      <div className='my-4 p-4 grid grid-cols-12 bg-white'>
        ...
        <div className='col-span-7 ml-5'>
          ...
          <div className='flex gap-3 mt-10 ml-3'>
            ...
            <button
              className='text-sm text-orange border border-orange p-2 min-w-[140px] hover:opacity-90 rounded-xl flex flex-col justify-center items-center hover:bg-orange hover:text-white duration-200 hover:font-semibold'
