      ...
      {!product ? (
        ...
        <div className='container'>
          <div className='grid grid-cols-12 bg-white rounded-xl p-4 my-4'>
            ...
            <div className='col-span-12 md:col-span-6 lg:col-span-6 mt-5 relative pl-5 flex items-center justify-center'>
          ...
          <div className='grid grid-cols-12 gap-3'>
            <div
              className={`col-span-8 rounded-xl bg-white p-3 text-orange text-lg  ${!showContent && 'max-h-[500px]'}  overflow-hidden relative inline-block px-4 py-2`}
            >
