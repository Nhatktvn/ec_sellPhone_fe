          ...
          <div className='grid grid-cols-12 gap-3'>
            <div className='col-span-7 bg-white rounded-xl'>
              <div className='w-full flex gap-10 justify-center my-4'>
                <button onClick={() => setSelectSpecOrReview('spec')} className={`py-3 px-6 border font-bold ${selectSpecOrReview == 'spec' ? 'border-blue-400 text-blue-400'} rounded-md`}>
                  Thông số kỹ thuật
                </button>
                <button onClick={() => setSelectSpecOrReview('review')}>Bài viết đánh giá</button>
              </div>
              <div className='p-4'>
                <div
