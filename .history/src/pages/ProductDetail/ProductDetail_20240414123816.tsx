      ...
      <div className='my-4 p-4 grid grid-cols-12 bg-white'>
        ...
        <div className='col-span-7 ml-5'>
          ...
          <div className='flex gap-3 mt-10 ml-3'>
            <button className='bg-orange relative text-white text-sm p-3 min-w-[140px] hover:opacity-90 rounded-xl'>
              Mua ngay
              <span className='w-full absolute h-full bg-white left-0 opacity-50 top-0 -translate-y-full'></span>
