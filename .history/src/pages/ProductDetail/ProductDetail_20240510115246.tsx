          ...
          <div className='grid grid-cols-12 gap-3'>
            ...
            <div className='col-span-4 rounded-xl bg-white p-2'>
              ...
              <table className='table-auto'>
                <tbody>
                  <tr>
                    <td className='w-max block mr-5 py-3'>Kích thước màn hình:</td>
                    <td>{product.specificationDTO.sizeScreen}</td>
                  </tr>
                  <tr>
                    <td className='py-3'>Công nghệ màn hình:</td>
                    <td>{product.specificationDTO.screenTechnology}</td>
                  </tr>
                  <tr>
                    <td className='py-3'>Camera sau:</td>
                    <td>{product.specificationDTO.cameraRear}</td>
                  </tr>
                  <tr>
                    <td className='py-3'>Camera trước:</td>
                    <td>{product.specificationDTO.cameraFront}</td>
                  </tr>
                  <tr>
                    <td className='py-3'>Chipset:</td>
                  ...
                  <tr>
                    <td className='py-3'>Rom:</td>
                    <td>{product.specificationDTO.rom}</td>
                  </tr>
                  <tr>
                    <td className='py-3'>Dung lượng pin:</td>
                    <td>{product.specificationDTO.battery}</td>
                  </tr>
                  <tr>
                    <td className='py-3'>Độ phân giải:</td>
                    <td>{product.specificationDTO.screenResolution}</td>
                  </tr>
                  <tr>
                    <td className='py-2'>Hệ điều hành:</td>
