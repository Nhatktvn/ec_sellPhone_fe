      ...
      {!product ? (
        ...
        <div className='container'>
          ...
          <div className='grid grid-cols-12 gap-3'>
            ...
            <div className='col-span-4 bg-white px-3 rounded-md py-5 flex-col gap-4'>
              ...
              <div className='flex gap-2 items-center text-gray-600 text-sm'>
                <div className='w-[50px] h-[50px]'>
                  <img src='https://cdnv2.tgdd.vn/pim/cdn/images/202410/Exchange150504.png' alt='' />
                </div>
                <span>1 đổi 1 trong 30 ngày đối với sản phẩm lỗi tại</span>
              </div>
              <div className='flex gap-2 items-center text-gray-600 text-sm'>
                <div className='w-[50px] h-[50px]'>
                  <img src='https://cdnv2.tgdd.vn/pim/cdn/images/202410/icon%20sp%20kem%20theo142836.png' alt='' />
                </div>
                <span>Bộ sản phẩm gồm: Hộp, Sách hướng dẫn, Cây lấy sim, Ốp lưng, Cáp sạc, Củ sạc nhanh rời</span>
              </div>
              <div className='flex gap-2 items-center text-gray-600 text-sm'>
                <div className='w-[50px] h-[50px]'>
                  <img src='https://cdnv2.tgdd.vn/pim/cdn/images/202410/icon%20bao%20hanh170837.png' alt='' />
                </div>
