...
const ProductDetail = () => {
  ...
  return (
    <div className='container'>
      <div className='my-4 p-4 grid grid-cols-10 bg-white'>
        ...
        <div className='col-span-6 ml-5'>
          ...
          <div className='flex gap-3 mt-10 ml-3'>
            <button
              className='text-sm text-orange border border-orange p-2 min-w-[140px] hover:opacity-90 rounded-xl flex flex-col justify-center items-center hover:bg-orange hover:text-white duration-200 transi'
              onClick={handleAddCart}
            >
              <IoCartOutline className='text-2xl' />
              Thêm vào giỏ
            </button>
            <button className='bg-orange text-white text-sm p-3 min-w-[140px] hover:opacity-90 rounded-sm '>
              Mua ngay
            </button>
          </div>
        </div>
