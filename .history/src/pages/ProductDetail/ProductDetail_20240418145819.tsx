      ...
      {!product ? (
        ...
        <div className='container'>
          <div className='grid grid-cols-12 bg-white rounded-xl p-4 my-4'>
            <div className='col-span-12 md:col-span-6 lg:col-span-5 flex justify-center flex-col'>
              <div className='w-full md:w-[400px] h-[400px] mb-5'>
                <img className='w-full h-full' src={imagePreview || product?.images[0].urlImage} alt='' />
              </div>
              <Swiper
                navigation
                slidesPerView={4}
                ...
                <div className='mt-10 ml-3 w-max'>
                  <div className='flex gap-3'>
                    <button className='bg-orange relative text-white text-sm p-3 min-w-[140px] hover:opacity-90 rounded-xl group overflow-hidden'>
                      ...
                      <span className='block md:hidden'>{`(Giao hàng tận nơi hoặc mua tại cửa hàng)`}</span>
                    </button>
                    <button
          ...
          <div className='grid grid-cols-12 gap-3'>
            <div className='col-span-9 rounded-xl bg-white p-2 text-orange text-lg font-semibold'>
              <h3 className='text-lg font-semibold'>Thông tin chi tiết</h3>
            </div>
            <div className='col-span-3 rounded-xl bg-white p-2'>
