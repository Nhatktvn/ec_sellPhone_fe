            ...
            {selectedChange && (
              <div className='text-end mt-5'>
                <button
                  ...
                  className='py-3 px-4 bg-gray-500 text-white rounded-md mr-3 active:scale-90 hover:bg-blue-700'
                >
                  Hủy
                </button>
                <button
                  className='py-3 px-4 bg-blue-600 text-white rounded-md mr-3 active:scale-90 hover:bg-blue-700'
