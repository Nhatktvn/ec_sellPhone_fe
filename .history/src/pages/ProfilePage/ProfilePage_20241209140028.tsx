          ...
          <div className='col-span-7 flex flex-col gap-2'>
            ...
            <div>
              ...
              {selectedChange ? (
                <input
                  ...
                  type='text'
                  className='block w-max border p-1  rounded-md'
                />
              ) : profileUser?.email ? (
            ...
            <div>
              ...
              {selectedChange ? (
                <input
                  ...
                  type='text'
                  className='block w-max border p-1 border-gray-400 rounded-md w-full'
                />
              ) : profileUser?.phone ? (
            ...
            {selectedChange && (
              <div className='text-end'>
                ...
                <button className='p-2 bg-blue-600 text-white rounded-md mr-3' onClick={handleUpdateProfile}>
                  Lưu
                </button>
              </div>
            )}
