      ...
      <div className='bg-white p-3 mt-5'>
        ...
        <div className='grid grid-cols-12'>
          ...
          <div className='col-span-7 flex flex-col gap-2'>
            ...
            {selectedChange && (
              <div>
                <button onClick={() => setSelectedChange(false)} className='p-2 bg-gray-500 text-white rounded-md'>
                  Hủy
                </button>
                <button className='p-2 bg-blue-600 text-white rounded-md'>Lưu</button>
              </div>
            )}
          </div>
        </div>
