  ...
  return (
    <div className='container w-[60%]'>
          ...
          <div className='col-span-5 flex items-center flex-col'>
            ...
            <div className='w-max text-sm'>
              ...
              <button
                ...
                className='block bg-blue-600 p-2 text-center text-white rounded-md'
              >
                Đổi mật khẩu
              </button>
            </div>
            ...
            {selectedChange && (
              <div className='text-end mt-5'>
                <button
                  ...
                  className='py-3 px-4 bg-gray-500 text-white rounded-md mr-3 active:scale-90 hover:bg-gray-700'
                >
                  Hủy
                </button>
                <button
                  className='py-3 px-4 bg-blue-500 text-white rounded-md mr-3 active:scale-90 hover:bg-blue-700'
      ...
      {isModalChangePassword && (
        <ModalUpdatePassword setShowModal={setIsModalChangePassword} showModal={isModalChangePassword} />
      )}
    </div>
  )
}
