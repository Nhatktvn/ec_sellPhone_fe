        ...
        return editable ? (
          ...
          <div className='flex  gap-4'>
            <Typography.Link onClick={() => edit(record)}>
              <span className='text-blue-500 hover:text-white hover:bg-blue-500 hover:font-medium p-2 rounded-md duration-200 box-border'>
                Edit
              </span>
            </Typography.Link>
            <Typography.Link onClick={() => edit(record)}>
              <span className='text-red-500 hover:text-white hover:bg-red-500 p-2 rounded-md duration-200 hover:font-semibold'>
                Delete
              </span>
            </Typography.Link>
          </div>
  ...
  return (
    <div>
      <div className='float-end'>
        <button className='bg-[#1677ff] text-white font-bold px-4 py-3 mr-5 rounded-md btn hover:opacity-85 active:scale-95 duration-150'>
          Add new
        </button>
      </div>
