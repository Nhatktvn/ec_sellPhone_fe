...
const AddNewProduct = () => {
  ...
  const handleCreateVariant = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    const { name, value }: { any; any } = e.target
    setFormData((prevFormData) => ({
      ...prevFormData,
      [name]: value
    }))
  }
  const handleAddListVariant = () => {}
  return (
        ...
        <div className='flex flex-col gap-1 col-span-12'>
          ...
          <div className='w-full flex gap-2 items-center'>
            ...
            <div className='w-max border-2 border-gray-400 rounded-md flex flex-col gap-1 p-2'>
              <input className='w-[150px] p-1' type='text' name='color' placeholder='Enter color...' />
              <input className='w-[150px] p-1' type='text' name='storageCapacity' placeholder='Enter storage...' />
              <input className='w-[150px] p-1' type='number' name='price' placeholder='Enter price...' />
            </div>
          </div>
        </div>
      </div>
