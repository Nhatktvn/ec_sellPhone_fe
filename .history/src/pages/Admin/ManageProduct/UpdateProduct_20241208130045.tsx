...
const UpdateProduct = () => {
  ...
  const [chooseCateName, setChooseCateName] = useState('')
  ...
  const [listVariant, setListVariant] = useState<variant[]>([
    { color: 'Trắng', ram: 6, storageCapacity: 64, originalPrice: 9590000, sellPrice: 9590000, available: 50 }
  ])
  console.log('name cate', chooseCateName)
  console.log(product)
  ...
  const [imageSpec, setImageSpec] = useState<string | ArrayBuffer | null>()
  const [imageSpecData, setImageSpecData] = useState<File | null>()
  ...
  const getAllCate = async () => {
    try {
      ...
      if (fecthAllCate.status == 200) {
        ...
        setChooseCateName(fecthAllCate.data[0].name)
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      ...
      if (e.target.name == 'imageThumb') {
        setImageThumb(reader.result)
        setImage(selectedFile)
      } else {
        setImageSpecData(selectedFile)
        setImageSpec(reader.result)
      }
  ...
  const handleAddListVariant = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      newVariant.color === '' ||
      newVariant.ram === 0 ||
      newVariant.storageCapacity === 0 ||
      newVariant.originalPrice == 0 ||
  ...
  console.log('choose Cate Name: ', chooseCateName)

  const handleAddProduct = async () => {
    try {
      console.log('add product')

      if (!image || !imageSpecData) {
        return
      }
      ...
      formData.append('imageSpec', imageSpecData)
  ...
  return (
    <div className=' w-full p-4 bg-gray-100 mt-[-10px]'>
      <div className=' grid grid-cols-12 gap-5'>
        <div className='col-span-5 bg-white p-4 rounded-lg'>
              ...
              >
                {listCategory &&
                  listCategory.map((cate: any) => {
                    if (cate.id == chooseCate && chooseCateName != cate.name) {
                      setChooseCateName(cate.name)
                    }
                    return (
                      <option value={cate.id} id={cate.name} key={cate.id}>
                        {cate.name}
                      </option>
                    )
                  })}
          ...
          <div className='flex flex-col gap-1 col-span-12 mt-2'>
            ...
            <div className='w-full h-[150px] flex justify-center'>
              ...
              >
                {product ? (
                  <img src={product.urlImage} alt='Preview' style={{ maxWidth: '150px', maxHeight: '150px' }} />
                ) : (
          ...
          <div className='flex flex-col gap-1 col-span-12'>
            ...
            <div className='w-full  grid grid-cols-12 gap-3 items-center'>
              {product && product.images.length > 0 && product.images.map((img: any, idx: number) =>{
                <label
          ...
          <div className='flex flex-col gap-1 col-span-12 mt-2'>
            <label className='font-medium text-lg' htmlFor='imageSpec'>
              Hình ảnh thông số:
            </label>
            <div className='w-full h-[150px] flex justify-center'>
              <label
              ...
              >
                {imageSpec ? (
                  <img src={imageSpec as string} alt='Preview' style={{ maxWidth: '150px', maxHeight: '150px' }} />
                ) : (
                  <div className='text-slate-400 text-3xl'>
                    <FaUpload />
                  </div>
        ...
        {specificationOfType(chooseCateName, changeInputSpecification, setSpecification, specification)}
                  ...
                  <div className='border-2 p-2 rounded-md relative group hover:border-orange duration-150' key={idx}>
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>{formatToVND(variant.originalPrice)}</td>
                      </tr>
                      <tr>
...
function specificationOfType(type: string, changeInputSpecification: any, setSpecification: any, specification: any) {
    ...
    case 'laptop':
      ...
      return (
        <div className='col-span-7 bg-white p-4 rounded-lg h-max'>
          <div className='grid grid-cols-12 gap-3'>
            <div className='flex flex-col gap-1 col-span-4'>
              <label className='font-medium text-lg' htmlFor='screen'>
                Thông tin màn hình:
              </label>
              <input
                placeholder='Enter information screen...'
                className='border h-8 px-2 border-gray-500 rounded-md'
                type='text'
                id='screen'
                name='screen'
            ...
            <div className='flex flex-col gap-1 col-span-4'>
              <label className='font-medium text-lg' htmlFor='cpu'>
                CPU:
              </label>
              <input
            ...
            <div className='flex flex-col gap-1 col-span-4'>
              <label className='font-medium text-lg' htmlFor='gpu'>
                Card đồ họa:
              </label>
              <input
            ...
            <div className='flex flex-col gap-1 col-span-3'>
              ...
              <input
                placeholder='Enter opera system...'
                className='border h-8 px-2 border-gray-500 rounded-md'
                type='text'
                id='operaSystem'
                name='operaSystem'
            ...
            <div className='flex flex-col gap-1 col-span-3'>
              <label className='font-medium text-lg' htmlFor='ports'>
                Cổng kết nối:
              </label>
              <input
            ...
            <div className='flex flex-col gap-1 col-span-12'>
              <label className='font-medium text-lg' htmlFor='additionalFeatures'>
                Tính năng thêm:
              </label>
              <input
