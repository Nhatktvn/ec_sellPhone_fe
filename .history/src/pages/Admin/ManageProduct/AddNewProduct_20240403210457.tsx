    ...
    <div>
      <div>
        ...
        <div className='w-[70%] mx-auto grid grid-cols-12 gap-3'>
          ...
          <div className='flex flex-col gap-1 col-span-12 bg-red-300'>
            <label className='font-medium text-lg' htmlFor='imageThumb'>
              Image thumb:
            </label>
            <div className='w-full bg-red-600 h-[150px]'>
              <label className='font-medium text-lg h-[150px] w-[150px]' htmlFor='imageThumb'>
                +
              </label>
              <input
                placeholder='Enter available...'
