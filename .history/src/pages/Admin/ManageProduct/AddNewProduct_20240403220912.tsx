        ...
        <div className='flex flex-col gap-1 col-span-12'>
          ...
          <div className='w-full flex gap-2 items-center'>
            ...
            <div className='w-[150px] border-2 border-gray-400 rounded-md'>
              ...
              <input className='w-[150px]' type='text' name='storageCapacity' placeholder='Enter storage...' />
              <input className='w-[150px]' type='number' name='price' placeholder='Enter price...' />
            </div>
          </div>
        </div>
      </div>
