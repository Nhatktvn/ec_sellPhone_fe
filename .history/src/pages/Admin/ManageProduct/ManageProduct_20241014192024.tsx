              ...
              return (
                ...
                >
                  ...
                  <td className='px-6 py-4 text-right'>
                    <button href='#' className='font-medium text-blue-600 dark:text-blue-500 hover:underline mr-5'>
                      Edit
                    </button>
                    <button href='#' className='font-medium text-red-600 dark:text-red-500 hover:underline'>
                      Delete
                    </button>
                  </td>
                </tr>
