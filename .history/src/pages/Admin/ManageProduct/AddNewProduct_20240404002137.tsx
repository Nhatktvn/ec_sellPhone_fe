          ...
          <div className='w-full flex gap-2 items-center'>
            ...
            {!isInputVariant ? (
              ...
              <form
                ...
                className='w-max border-2 border-gray-400 rounded-md flex flex-col gap-1 p-2 relative focus:border-red-600'
              >
                <button className='text-red-600 font-bold text-2xl absolute top-0 right-0'>
                  <TiDelete />
                </button>
                <input
