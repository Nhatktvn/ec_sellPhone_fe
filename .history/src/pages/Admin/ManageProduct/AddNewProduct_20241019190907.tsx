...
const AddNewProduct = () => {
  ...
  return (
    <div className='my-10 w-full p-4 bg-gray-100'>
      <div className=' grid grid-cols-12 gap-5'>
        <div className='col-span-5 bg-white p-3 rounded-lg'>
        ...
        <div className='col-span-7 bg-white p-3 rounded-lg max-w'>
          <h4 className='font-medium text-lg'>Specification:</h4>
      ...
      <div className='flex gap-5 float-end font-medium my-5'>
        ...
        <button className='min-w-[65px] bg-blue-500 text-white py-3 px-3 rounded-md hover:bg-blue-600 hover:font-bold'>
          Save
        </button>
      </div>
    </div>
...
function specificationOfType(type: string) {
  return null
}
