  ...
  return (
    <div className=' w-full p-4 bg-gray-100 mt-[-10px]'>
      <div className=' grid grid-cols-12 gap-5'>
        ...
        {specificationOfType(chooseCateName, changeInputSpecification, setSpecification)}
...
function specificationOfType(type: string, changeInputSpecification: any, setSpecification: any) {
