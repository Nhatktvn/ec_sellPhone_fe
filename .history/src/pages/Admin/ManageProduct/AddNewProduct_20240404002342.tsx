          ...
          <div className='w-full flex gap-2 items-center'>
            {listVariant &&
              listVariant.map((variant, idx) => {
                return (
                  <div className='border-2 p-2 rounded-md relative group hover:border-orange' key={idx}>
                    <button
                      className='text-red-600 font-bold p-1 absolute hidden group-hover:block top-0 right-0 text-2xl'
