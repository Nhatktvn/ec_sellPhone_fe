    ...
    <div className='my-10 w-[70%] mx-auto'>
      ...
      <div className='flex gap-5 float-end font-medium my-5'>
        <Link
          ...
          className='block min-w-[65px] bg-slate-400 text-white py-3 px-3 rounded-md hover:bg-slate-500 hover:font-bold '
        >
          Cancel
        </Link>
        <button
          className='min-w-[65px] bg-blue-500 text-white py-3 rounded-md hover:bg-blue-600 hover:font-bold'
