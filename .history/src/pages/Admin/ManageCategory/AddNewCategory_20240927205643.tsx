...
import { addCategory } from '../../../apis/brand.api'
...
const AddNewCategory = () => {
  ...
  const handleGetAllCate = async () => {
    try {
      ...
      if (getAllCate.status == 200) {
        console.log(getAllCate.data)
      }
    } catch (error) {
      console.log(error)
    }
    ...
    <div className='my-10 w-[70%] mx-auto'>
      <div className=' grid grid-cols-12 gap-3'>
        ...
        <div className='flex flex-col gap-1 col-span-6'>
          ...
          <select name='' id='' className='border h-8 px-2 border-gray-500 rounded-md cursor-pointer'>
