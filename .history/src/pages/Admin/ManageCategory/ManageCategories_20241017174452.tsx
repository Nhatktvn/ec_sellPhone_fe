...
function ManageCategories() {
  ...
  const handleDeleteCategory = async (idCateDelete: number | undefined) => {
    try {
      console.log(idCateDelete)
    } catch (error) {
      console.log(error)
    }
  }
  return (
    <div className='relative overflow-x-auto shadow-md sm:rounded-lg'>
      ...
      {isModal && (
        <ModalConfirmDelete setShowModal={setIsModal} showModal={isModal} handleDelete={handleDeleteCategory} />
      )}
    </div>
  )
}
