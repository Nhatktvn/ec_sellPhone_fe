      ...
      <div className=' grid grid-cols-12 gap-3'>
        ...
        <div className='flex flex-col gap-1 col-span-12'>
          ...
          <div className='w-full h-[150px] flex justify-center'>
            <label
              className='cursor-pointer font-medium h-[150px] w-[150px] flex justify-center items-center text-xl rounded-3xl border-4 border-dashed active:scale-95 duration-100'
              htmlFor='imageThumb'
            >
              {imageThumb ? (
