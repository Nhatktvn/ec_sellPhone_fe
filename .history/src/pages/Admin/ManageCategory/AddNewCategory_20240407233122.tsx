      ...
      <div className=' grid grid-cols-12 gap-3'>
        ...
        <div className='flex flex-col gap-1 col-span-12'>
          ...
          <div className='w-full h-[150px] flex justify-center'>
            <label
              className='cursor-pointer font-medium h-[150px] w-[150px] flex justify-center items-center text-xl rounded-3xl border-4 border-dashed active:scale-95 duration-1000'
              htmlFor='imageThumb'
            >
              {imageThumb ? (
        ...
        <div className='flex flex-col h-max gap-1 col-span-12'>
          ...
          <textarea
            ...
            className='border px-2 border-gray-500 rounded-md min-h-[200px]'
            id='name'
            name='name'
          ></textarea>
        </div>
