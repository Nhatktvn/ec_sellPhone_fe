...
import ModalUpdateCate from '../../../components/Modal/ModalUpdateCate'
...
function ManageCategories() {
  ...
  return (
    <div className='relative overflow-x-auto shadow-md sm:rounded-lg'>
            ...
            listCategories.map((p: any, idx) => {
              return (
                ...
                >
                  ...
                  <td className='px-6 py-4 text-right w-full justify-center flex gap-5'>
                    <button
                      onClick={() => {
      ...
      {isModalEdit && (
        <ModalUpdateCate
          fetchGetData={() => getListCategories()}
