...
import { deleteCategoryById, getCategories } from '../../../apis/category.api'
...
const App: React.FC = () => {
  ...
  const edit = (record: Partial<product> & { id: number }) => {
    const { id, name, discount, urlImage } = { ...record }
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: product) => {
        return <img className='w-16 h-16 object-cover' src={`${record.urlImage}`} />
      }
    },
    {
      title: 'Description',
