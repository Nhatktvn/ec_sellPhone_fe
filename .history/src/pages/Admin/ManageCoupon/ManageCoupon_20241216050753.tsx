...
const ManageCoupon = () => {
  ...
  const handleDeleteCoupon = async () => {
    try {
      const fetchDeleteCoupon = await deleteCoupon(dataCouponChoose.id)
              ...
              return (
                ...
                >
                  ...
                  <td className='px-6 py-4 flex gap-2'>
                    ...
                    <button className='font-medium text-white bg-red-600 py-1 px-2 rounded-md active:scale-95 duration-100'>
                      Xóa
                    </button>
                  </td>
                </tr>
