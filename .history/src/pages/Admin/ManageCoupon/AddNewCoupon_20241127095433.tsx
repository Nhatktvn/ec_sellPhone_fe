...
const CouponCreationPage = () => {
  ...
  const validateForm = () => {
    let tempErrors: any = {}
    if (!formData.discountType) tempErrors.discountType = 'Please select a discount type'
    if (!formData.discountValue) {
      tempErrors.discountValue = 'Please enter a discount value'
    ...
    if (!formData.minAmount || formData.minAmount < 0) {
      tempErrors.minAmount = 'Please enter a valid minimum amount'
    }
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                ...
                <select
                  ...
                  className={`mt-1 block w-full pl-3 pr-10 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md transition duration-150 ease-in-out ${errors.discountType ? 'border-red-500 ring-red-500' : ''}`}
              ...
              <div>
                ...
                <div className='mt-1 relative rounded-md shadow-sm'>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full pl-10 pr-3 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md transition duration-150 ease-in-out ${errors.discountValue ? 'border-red-500 ring-red-500' : ''}`}
              ...
              <div>
                ...
                <div className='mt-1 relative rounded-md shadow-sm'>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full pl-10 pr-3 py-3 text-base border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md transition duration-150 ease-in-out ${errors.minAmount ? 'border-red-500 ring-red-500' : ''}`}
