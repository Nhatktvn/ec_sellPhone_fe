...
import { addCoupon } from '../../../apis/coupon.api'
...
const CouponCreationPage = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (validateForm()) {
      ...
      try {
        const fetchAddCoupon = await addCoupon(formData)
        if (fetchAddCoupon && fetchAddCoupon.status == 200) {
          toast.success('Thêm mã coupon thành công')
          navigation('/admin/manage-coupon')
        }
      } catch (error) {
        console.log(error)
      }
      ...
      <div className='max-w-3xl mx-auto'>
        <div className='bg-white shadow-xl rounded-lg p-6 md:p-8 space-y-8'>
          <div className='text-center'>
            <h2 className='text-3xl font-bold text-gray-900 mb-2'>Tạo phiếu giảm giá</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div>
                ...
                >
                  <option value=''>Loại coupon</option>
