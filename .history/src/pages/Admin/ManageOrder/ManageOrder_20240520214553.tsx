        ...
        <tbody>
          {listOrder && listOrder.length > 0 ? (
            listOrder.map((order, idx) => {
              return (
                <tr key={order.id}>
                  <td className='bg-gray-300'>{idx + 1}</td>
                  <td>{order.name}</td>
                  <td className='bg-gray-300'>{order.phone}</td>
                  <td>{order.address}</td>
                  <td className='bg-gray-300'>{order.deliveryTime}</td>
                  <td>{order.totalPrice}</td>
                  <td className='bg-gray-300'>{order.statusOrder}</td>
