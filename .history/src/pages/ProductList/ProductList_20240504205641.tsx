            ...
            <div className='text-sm'>
              <div className='flex flex-col gap-2 mt-2'>
                <div className='flex gap-2 items-center'>
                  ...
                  />
                  <label htmlFor='under2m'>Dưới 2 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input
                    type='checkbox'
                    ...
                    onChange={handleChangeInputPrice}
                  />
                  <label htmlFor='2mTo4m'>Từ 2 - 4 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input
                    type='checkbox'
                    ...
                    onChange={handleChangeInputPrice}
                  />
                  <label htmlFor='4mTo7m'>Từ 4 - 7 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input
                    type='checkbox'
                    ...
                    onChange={handleChangeInputPrice}
                  />
                  <label htmlFor='7mTo13m'>Từ 7 - 13 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input
                    type='checkbox'
                    ...
                    onChange={handleChangeInputPrice}
                  />
                  <label htmlFor='above13m'>Trên 13 triệu</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='grid grid-cols-12 gap-3 m-3 '>
            {!productsFilter ? (
              <div className='col-span-12 mt-10 mx-auto'>
                <span className='mx-auto animate-spin h-10 w-10 block border-[4px] border-l-transparent rounded-full border-spacing-2 border-orange z-10'>
                  ok
                </span>
              </div>
            ) : (
