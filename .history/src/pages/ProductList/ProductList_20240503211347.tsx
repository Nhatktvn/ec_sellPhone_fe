        ...
        <div className='col-span-12 md:col-span-3 pl-5'>
          <div className='mb-7'>
            ...
            <div className='text-sm grid grid-cols-2 gap-3'>
              <label className='col-span-1 flex gap-2 items-center'>
                <input type='radio' name='cateSelect' id='' className='mr-2 ' />
                <span htmlFor=''>Tất cả</span>
              </label>
              {listCategory &&
                listCategory.length > 0 &&
                listCategory.map((cate) => (
                  <label htmlFor='' key={cate.id} className='col-span-1 flex gap-2 items-center'>
