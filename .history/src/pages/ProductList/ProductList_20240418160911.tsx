    ...
    <div className='container'>
      <div className='main-filter mt-5 grid grid-cols-12'>
        ...
        <div className='col-span-12 md:col-span-9'>
          ...
          <div className='grid grid-cols-12 gap-3 m-3 bg-orange'>
            {
              products && (
                <div className='mx-auto animate-spin h-10 w-10 block border-[4px] border-l-transparent rounded-full border-spacing-2 border-orange z-10'></div>
              )
              // ) : (
              //   products.length > 0 &&
