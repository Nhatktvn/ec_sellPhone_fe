          ...
          <div>
            ...
            <div className='text-sm'>
              <div className='flex flex-col gap-2 mt-2'>
                ...
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' value={'2mTo4m'} className='mr-2 ' />
                  <label htmlFor=''>Từ 2 - 4 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' value={'4mTo7m'} className='mr-2 ' />
                  <label htmlFor=''>Từ 4 - 7 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' value={'7mTo13m'} className='mr-2 ' />
                  <label htmlFor=''>Từ 7 - 13 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' value={'above13m'} className='mr-2 ' />
