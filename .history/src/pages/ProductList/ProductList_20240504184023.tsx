...
export default function ProductList() {
  ...
  const handleChangeInputPrice = (e: ChangeEvent) => {}
            ...
            <div className='text-sm'>
              <div className='flex flex-col gap-2 mt-2'>
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' value={'2'} className='mr-2 ' onChange={handleChangeInputPrice} />
                  <label htmlFor=''>Dưới 2 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' value={'2-4'} className='mr-2 ' />
                  <label htmlFor=''>Từ 2 - 4 triệu</label>
                </div>
                <div className='flex gap-2 items-center'>
                  <input type='checkbox' name='price' id='' className='mr-2 ' />
