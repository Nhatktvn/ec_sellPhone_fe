        ...
        <div className='col-span-12 md:col-span-3 pl-5'>
          <div className='mb-7'>
            ...
            <div className='text-sm grid grid-cols-2 gap-3'>
              <label htmlFor='cate-all' className='col-span-1 flex gap-2 items-center'>
              ...
              {listCategory &&
                ...
                listCategory.map((cate) => (
                  <label htmlFor={`cate-${cate.id}`} key={cate.id} className='col-span-1 flex gap-2 items-center'>
                    <input type='radio' name='cateSelect' id={`cate-${cate.id}`} className='mr-2 ' />
                    <span>{cate.name}</span>
                  </label>
                ))}
            </div>
