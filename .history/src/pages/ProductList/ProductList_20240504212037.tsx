          ...
          <div>
            ...
            <div className='text-sm grid grid-cols-2 gap-2'>
              <label htmlFor='' className='flex gap-2 items-center'>
                <input type='checkbox' name='storage' value='32GB' onChange={handleChangeInputStorage} />
                <span>32GB</span>
              </label>
              <label htmlFor='' className='flex gap-2 items-center'>
                <input type='checkbox' name='storage' value='64GB' onChange={handleChangeInputStorage} />
                <span>64GB</span>
              </label>
              <label htmlFor='' className='flex gap-2 items-center'>
                <input type='checkbox' name='storage' value='128GB' onChange={handleChangeInputStorage} />
                <span>128GB</span>
              </label>
              <label htmlFor='' className='flex gap-2 items-center'>
                <input type='checkbox' name='storage' value='256GB' onChange={handleChangeInputStorage} />
                <span>256GB</span>
              </label>
              <label htmlFor='' className='flex gap-2 items-center'>
                <input type='checkbox' name='storage' value='512GB' onChange={handleChangeInputStorage} />
                <span>512GB</span>
              </label>
              <label htmlFor='' className='flex gap-2 items-center'>
                <input type='checkbox' name='storage' value='1TB' onChange={handleChangeInputStorage} />
                <span>1TB</span>
              </label>
            </div>
          </div>
