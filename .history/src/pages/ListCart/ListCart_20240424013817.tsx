    ...
    <div className='container grid grid-cols-12 gap-3 mt-5'>
      ...
      <div className='lg:col-span-5 h-full bg-white rounded-xl p-3'>
        ...
        <div className='grid grid-cols-12 gap-2 mt-5'>
          <select className='col-span-6 border p-2 rounded-md' id='provinceName' onChange={handleChangeProvince}>
          ...
          <select className='col-span-6 border p-2 rounded-md' id='districtName' onChange={handleChangeDistrict}>
          ...
          <select className='col-span-6 border p-2 rounded-md' id='wardName'>
