    ...
    <div className='container min-h-[60vh] w-[60vw] rounded-xl bg-white mt-5 p-3'>
      ...
      <div className='w-full'>
        <div className='flex gap-2'>
          ...
          <div>
            <h4 className='text-xl'>Máy tính xách tay Macbook Air 13 2020 M1/8GB/256GB SSD</h4>
            <div className='flex gap-4 text-sm mt-2'>
              <div>
                <p>Màu sắc</p>
                <div className='p-2 rounded-full border w-max'>Titan xanh</div>
              </div>
              <div>
                <p>Dung lượng</p>
                <div className='p-2 rounded-full border w-max'>128GB</div>
              </div>
              <div>
                <p>Số lượng</p>
                <div>Titan xanh</div>
