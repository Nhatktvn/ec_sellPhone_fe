        ...
        <div className='flex gap-4'>
          ...
          <div>
            ...
            <div className='flex gap-4 text-sm mt-2'>
              <div>
                <p>Màu sắc</p>
                <div className='p-1 rounded-full border w-max'>Titan xanh</div>
              </div>
              <div>
                <p>Dung lượng</p>
                <div className='py-1 px-2s rounded-full border w-max'>128GB</div>
              </div>
              <div>
                <p>Số lượng</p>
                <div>
                  <button>-</button>
                  <input type='number' name='' id='' className='border w-[50px] text-center p-1' />
                  <button>+</button>
                </div>
              </div>
            </div>
