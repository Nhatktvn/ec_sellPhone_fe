    ...
    <div className='container grid grid-cols-12 gap-3 mt-5'>
      ...
      <div className='lg:col-span-5 h-full bg-white rounded-xl p-3'>
        ...
        <div className='grid grid-cols-12 gap-2 mt-5'>
          <select className='col-span-6 border p-2 rounded-md' id='province' onChange={handleChangeProvince}>
          ...
          <select className='col-span-6 border p-2 rounded-md' id='district' onChange={handleChangeDistrict}>
          ...
          <select className='col-span-6 border p-2 rounded-md' id='district'>
            <option value='0'>Chọn Phường / Thành Phố</option>
            {listWard &&
