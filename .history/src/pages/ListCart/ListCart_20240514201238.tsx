                  ...
                  <div key={idx} className='flex gap-4 relative border-b p-2'>
                    ...
                    <div className='w-full'>
                      ...
                      <div className='flex mt-2 justify-between'>
                        ...
                        <div>
                          <p className='text-xl text-red-600 font-bold'>{formatToVND(item.sellPrice)}</p>
          ...
          <p className='flex justify-between my-1 text-xl'>
            ...
            <span>
              {cartItems
                ? formatToVND(
                    cartItems?.reduce((accumulator, currentValue) => {
                      return accumulator + (currentValue.originalPrice - currentValue.sellPrice) * currentValue.quantity
                    }, 0)
                  )
                : formatToVND(0)}
            </span>
