...
export default function ListCart() {
  ...
  const fetchCreateOrderGHN = async () => {
    try {
      ...
      const apicreateOrder = createOrderGHN(data)
      console.log(createOrderGHN(data))
      // if (apicreateOrder && apicreateOrder.status == 200) {
      //   console.log(apicreateOrder.data.order_code)
      //   // handleOrder(apicreateOrder.data.order_code)
      // }
    } catch (error) {
      console.log(error)
    }
