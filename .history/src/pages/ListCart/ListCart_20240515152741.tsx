...
export default function ListCart() {
  ...
  const handleChangeQuantity = async (idCartItem: number, quantity: number) => {
    hanndleFetchUpdateQuantity(idCartItem, quantity)
  }

  const hanndleFetchUpdateQuantity = async (idCartItem: number, quantity: number) => {
    try {
      const dataBody = { idCartItem, quantity: quantity + 1 }
