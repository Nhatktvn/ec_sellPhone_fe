...
export default function ListCart() {
  ...
  const handleUpdateQuantity = async (idProduct: number, quantity: number) => {
    ...
    }, 1000) // Chờ 500ms sau khi người dùng ngừng nhập

    return () => {
      clearTimeout(handler) // Xóa timeout trước đó nếu người dùng nhập thêm
    }
  }
                          ...
                          <div className='col-span-3'>
                            ...
                            <div>
                              ...
                              <button
                                ...
                                onClick={() => handleUpdateQuantity(item.addedDate, item.quantity)}
                              >
                                +
                              </button>
                            </div>
