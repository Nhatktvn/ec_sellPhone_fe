    ...
    <div className='container grid grid-cols-12 gap-3 mt-5'>
      ...
      <div className='lg:col-span-5 h-full bg-white rounded-xl p-3'>
        ...
        <div className='grid grid-cols-12 gap-2 mt-4'>
          <input className='col-span-6 border p-2 text-sm rounded-lg' type='text' placeholder='Họ và tên' />
          <input className='col-span-6 border p-2 text-sm' type='text' placeholder='Số điện thoại' />
        </div>
      </div>
    </div>
  )
