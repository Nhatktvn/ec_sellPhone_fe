          ...
          <div className='space-y-4 mb-5'>
            {listOrder &&
              listOrder.map((order: any, idx: any) => {
                return (
                  <div className='block p-6 cursor-pointer hover:shadow-lg rounded-md transition-shadow duration-200 overflow-hidden bg-white'>
                    <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 h-full'>
                      ...
                      <div className='flex flex-col gap-2 items-end bg-red-200 h-full w-full'>
