      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='space-y-4 mb-5'>
          {listOrder.map((order: any, idx: any) => {
            ...
            return (
              <div className='p-6 cursor-pointer hover:shadow-lg rounded-md transition-shadow duration-200 overflow-hidden'>
                    ...
                    {order.cartLineItemResponseDTOs.map((item: any, index: any) => (
                      <div key={index} className='flex items-center gap-4 p-4 bg-gray-50 rounded-lg' role='listitem'>
                        ...
                        <div>
                          ...
                          <p className='text-sm font-medium text-gray-900'>{formatToVND(item.)}</p>
                        </div>
                      </div>
                    ))}
                  </div>
