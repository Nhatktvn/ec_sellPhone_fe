...
const PageListOrder1 = () => {
  ...
  const renderTextStatus = (status: string) => {
    if (status != 'ready_to_pick' && status != 'return' && status != 'cancel') {
                    ...
                    <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4'>
                      ...
                      <div className='flex flex-col gap-2 items-end'>
                        {order.status == 'ready_to_pick' && (
                          <button className='text-red-600 flex gap-1 items-center font-bold border-2 border-red-600 p-2 rounded-lg active:scale-75'>
