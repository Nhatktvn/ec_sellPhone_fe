          ...
          {listOrderFilter &&
            ...
            listOrderFilter.map((order) => (
              <li className='flex justify-between w-[70%] bg-white p-3 rounded-md'>
                <div>
                  <p>
                    <span className='font-bold'>Số lượng:</span> {order.cartLineItemResponseDTOs.length}
                  </p>
                  <p>
                    <span className='font-bold'>Tên:</span> {order.name}
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <span>{order.vnPayResponseDTO ? 'Đã thanh toán' : 'Thanh toán khi nhận hàng'}</span>
                  </p>
                </div>
