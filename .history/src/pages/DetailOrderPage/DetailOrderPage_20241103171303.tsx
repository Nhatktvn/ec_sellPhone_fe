  ...
  return (
    <div className='container p-2 my-5 rounded-sm'>
      ...
      <div className='grid grid-cols-12 mt-4 gap-4'>
        <div className='lg:col-span-7 col-span-12  bg-white p-2 rounded-md lg:order-1 order-2'>
        ...
        <div className='lg:col-span-5 col-span-12 bg-white p-2 rounded-md h-max lg:order-2 order-1'>
