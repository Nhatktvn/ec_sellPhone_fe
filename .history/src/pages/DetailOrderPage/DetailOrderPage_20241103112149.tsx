...
function DetailOrderPage() {
  ...
  const handleGetDetailOrder = async () => {
    try {
      const rsDetailOrder = await getDetailOrderByCodeOrder(id)
  ...
  return (
    <div className='container p-2 my-5 rounded-sm'>
      <div className='text-xl flex items-center gap-2 text-blue-500'>
        <IoReturnDownBack />
        <span>Trở lại trang đơn hàng</span>
      </div>
      ...
      <div className='grid grid-cols-12 mt-4 gap-4'>
        <div className='col-span-8 bg-white p-2 rounded-md'>
          ...
          <div className='h-[500px] scroll-cart-details'>
            {order &&
        ...
        <div className='col-span-4 bg-white p-2 rounded-md h-max'>
