    ...
    <>
      <div className='justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none '>
        <div className='relative w-auto my-6 mx-auto max-w-3xl'>
          <span className='text-orange text-2xl bg-black cursor-pointer absolute top-5 right-5 z-[100]'>
            <IoMdClose />
          </span>
          {/*content*/}
            ...
            <div className='grid grid-cols-12 bg-white py-5'>
              ...
              <div className='lg:col-span-7 p-2'>
                ...
                <div className='mt-5 flex gap-3 items-center'>
                  ...
                  <button className='uppercase bg-orange text-white font-bold p-2 rounded-md'>Thêm vào giỏ</button>
                </div>
