                  ...
                  <ul className='flex gap-5'>
                    {listColor &&
                      listColor.map((color, idx) => {
                        return (
                          <li key={idx} className='border p-2 rounded-md cursor-pointer mt-1'>
                            {color}
                          </li>
                        )
                      })}
                  ...
                  <div className='flex gap-5 mt-2'>
                    {listStorage &&
                      listStorage.map((storage, idx) => {
                        return (
                          <label key={idx} htmlFor={`${storage.storage}`} className={`border p-2 rounded-md`}>
                            <div className='font-semibold text-center flex gap-1 bg-red-400 justify-center items-center'>
                              <input
