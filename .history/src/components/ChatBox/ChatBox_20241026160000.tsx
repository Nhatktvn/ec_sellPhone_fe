...
function ChatBox(props: Props) {
  ...
  return (
    <div className='z-50 fixed bottom-0 right-0 w-[500px] h-max  bg-gray-50 shadow-xl rounded-lg overflow-hidden'>
      <div className='bg-indigo-600 p-3' onClick={() => props.setShowChat(!props.showChat)}>
        <h1 className='text-white text-xl font-semibold'>Chat Bot</h1>
      </div>
