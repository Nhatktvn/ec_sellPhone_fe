...
const ChatBox: React.FC = () => {
  ...
  return (
    <div className='z-50 fixed bottom-[300px] right-0 max-w-4xl max-h-[500px]  bg-gray-50 shadow-xl rounded-lg overflow-hidden'>
      <div className='bg-indigo-600 p-4'>
        <h1 className='text-white text-xl font-semibold'>Chat Room</h1>
      </div>

      <div ref={chatContainerRef} className='flex-1 p-4 space-y-4 h-[400px]' role='log' aria-label='Chat messages'>
        {messages.map((message) => (
          ...
          >
            ...
            >
              ...
              />
              <div
                className={`px-4 py-2 rounded-2xl ${message.sender === 'user' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-800'} shadow-md`}
              >
