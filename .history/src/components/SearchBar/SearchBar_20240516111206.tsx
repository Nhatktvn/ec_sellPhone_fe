  ...
  return (
    <div className='w-[80%] mx-auto'>
      <div ref={containInputSearch} className='bg-white rounded-xl p-1 flex w-full relative'>
        ...
        {inputSearch && (
          <div className='w-full min-h-20 bg-white absolute top-full z-10 shadow-md mt-1 rounded-sm p-4'>
            <div className=''>
              ...
              <ul className='mt-2'>
                {listSuggetSearch &&
                  ...
                  listSuggetSearch.map((sugget) => (
                    <li className='hover:bg-gray-200 p-2 rounded-md cursor-pointer flex gap-3'>
