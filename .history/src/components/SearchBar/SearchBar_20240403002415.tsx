...
const SearchBar = () => {
  ...
  return (
    <div className='w-full relative' onFocus={() => setShowSearch(true)}>
      ...
      {showSearch && <div className='w-full min-h-20 bg-white absolute z-10 shadow-xl mt-1 rounded-md' onBlur={() => setShowSearch(false)></div>}
    </div>
  )
}
