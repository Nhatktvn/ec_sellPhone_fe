...
const SearchBar = () => {
  ...
  return (
    <div className='w-full relative' onFocus={() => setShowSearch(true)} onBlur={() => setShowSearch(false)}>
      ...
      {showSearch && <div className='w-full min-h-20 bg-white absolute z-10 shadow-xl mt-1 rounded-md'></div>}
    </div>
  )
}
