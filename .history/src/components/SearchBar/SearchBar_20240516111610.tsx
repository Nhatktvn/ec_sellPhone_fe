                  ...
                  listSuggetSearch.map((sugget) => (
                    <li className='hover:bg-gray-200 p-2 rounded-md cursor-pointer flex gap-3 border-b-2'>
                      ...
                      <div>
                        <h4>{sugget.name}</h4>
                        <div>
                          <span className='text-orange text-base'>{sugget.variantDTOList[0].sellPrice}</span>
                          <span className='text-gray-500 line-through'>{sugget.variantDTOList[0].sellPrice}</span>
                        </div>
                      </div>
                    </li>
                  ))}
