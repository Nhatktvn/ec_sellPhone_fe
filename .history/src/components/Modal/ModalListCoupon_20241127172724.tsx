  ...
  return (
    <div className='w-[100vw] h-[100vh] fixed top-0 right-0 left-0 z-50 bg-slate-400/50'>
      <div id='popup-modal' tabIndex={-1} className='flex z-50 justify-center items-center w-[100vw] h-[100vh]'>
        <div className='relative  p-4 max-w-md h-max bg-white rounded-lg max-h-[300px] overflow-y-scroll'>
          <div className='max-w-3xl mx-auto p-4'>
            <div className='space-y-4 list-voucher'>
              {coupons.map((coupon) => (
                <div
                  key={coupon.id}
            ...
            <div className='flex w-full justify-center mt-4'>
              <button className='bg-gray-300 py-2 px-3 rounded-lg font-bold active:scale-90 duration-150'>Hủy</button>
            </div>
          </div>
        </div>
      </div>
