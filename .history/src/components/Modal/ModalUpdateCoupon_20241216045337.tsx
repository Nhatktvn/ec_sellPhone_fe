                ...
                <div className='bg-white shadow-xl rounded-lg p-6 md:p-8 space-y-8'>
                  ...
                  <form onSubmit={handleUpdateCoupon} className='space-y-6'>
                    ...
                    <div className='flex items-center justify-center pt-6 gap-3'>
                      ...
                      <button
                        className='w-full md:w-auto px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-400 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out transform hover:scale-105'
                        aria-label='Create coupon'
                      >
                        Hủy
                      </button>
