...
const ModalUpdatePassword = (props: props) => {
  ...
  const handleUpdateCate = async () => {
    try {
      ...
      const fetchApiUpdatePassword = await changePassword(password, newPassword)
      if (fetchApiUpdatePassword && fetchApiUpdatePassword.status == 200) {
        console.log(fetchApiUpdatePassword)
        ...
        <div id='popup-modal' tabIndex={-1} className='flex z-50 justify-center items-center w-[100vw] h-[100vh]'>
          <div className='relative  p-4 w-[500px] max-h-full '>
            <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
              ...
              <div className='p-5'>
                <h3 className='my-3 text-2xl text-center'>ĐỔI MẬT KHẨU</h3>
                <div>
                  ...
                  <div className='relative z-0 w-full mb-5 group'>
                    ...
                    {errorPassword && <h3 className='text-red-600 mt-2'>{errorPassword}</h3>}
                  </div>
                </div>
                <div>
                  <button
