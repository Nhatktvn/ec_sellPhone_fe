...
function Specifacation(props: props) {
  ...
  console.log(product.variantDTOList[0].ram)
  ...
  return (
    <div>
      ...
      <table className='table-auto'>
        {(() => {
          if (
            product.category_name.toLocaleLowerCase() == 'điện thoại' ||
            product.category_name.toLocaleLowerCase() == 'tablet'
          ) {
            return (
              <tbody className='rounded-lg block overflow-hidden border-gray-300 border'>
                ...
                <tr>
                  ...
                  <td>{product.variantDTOList[0].ram} GB</td>
                </tr>
                <tr className='bg-gray-100'>
                  <td className='py-2 font-bold'>
                    <span className='pl-2'>Rom</span>
                  </td>
                  <td>{product.variantDTOList[0].storageCapacity} GB</td>
                </tr>
                <tr>
                  <td className='py-2 font-bold'>
                    <span className='pl-2'>Dung lượng pin</span>
                  </td>
                  <td>{product.specificationDTO.battery}mAh</td>
                </tr>
                <tr className='bg-gray-100'>
                  <td className='py-2 font-bold'>
            ...
            return (
              <tbody className='rounded-lg block overflow-hidden border-gray-300 border'>
                <tr className='bg-gray-100'>
                  <td className='w-max block mr-5 py-2 font-bold pl-2'>Kích thước màn hình:</td>
                  <td>{product.specificationDTO.screen}</td>
                </tr>
                <tr>
                  <td className='py-2 font-bold pl-2'>Công nghệ CPU:</td>
                  <td>{product.specificationDTO.cpu}</td>
                </tr>
                <tr className='bg-gray-100'>
                  <td className='py-2 font-bold pl-2'>Card màn hình:</td>
                  <td>{product.specificationDTO.gpu}</td>
                </tr>
                <tr>
                  <td className='py-2 font-bold pl-2'>RAM:</td>
                  <td>{product.variantDTOList[0].ram}</td>
                </tr>
                <tr className='bg-gray-100'>
                  <td className='py-2 font-bold pl-2'>Bộ nhớ:</td>
                  <td>{product.specificationDTO.rom}</td>
                </tr>
                <tr>
                  <td className='py-2 font-bold pl-2'>Pin:</td>
                  <td>{product.specificationDTO.battery}</td>
                </tr>
                <tr className='bg-gray-100'>
                  <td className='py-2 font-bold pl-2'>Hệ điều hành:</td>
                  <td>{product.specificationDTO.operaSystem}</td>
                </tr>
                <tr>
                  <td className='py-2 font-bold pl-2'>Trọng lượng:</td>
                  <td>{product.specificationDTO.weight}</td>
                </tr>
                <tr className='bg-gray-100'>
                  <td className='py-2 font-bold pl-2'>Cổng kết nối:</td>
                  <td>{product.specificationDTO.ports}</td>
                </tr>
                <tr>
                  <td className='py-2 font-bold pl-2'>Tính năng nổi bật:</td>
