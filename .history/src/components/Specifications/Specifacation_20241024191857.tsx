    ...
    <div>
      ...
      <table className='table-auto'>
        <table class='table-fixed w-full'>
          <tbody>
            <tr>
              <td class='w-1/4 p-4 font-bold'>Tên:</td>
              <td class='w-3/4 p-4'>Nguyễn Văn A</td>
            </tr>
            <tr>
              <td class='w-1/4 p-4 font-bold'>Tuổi:</td>
              <td class='w-3/4 p-4'>30</td>
            </tr>
            <tr>
              <td class='w-1/4 p-4 font-bold'>Địa chỉ:</td>
              <td class='w-3/4 p-4'>Hà Nội</td>
            </tr>
          </tbody>
        </table>
        {(() => {
