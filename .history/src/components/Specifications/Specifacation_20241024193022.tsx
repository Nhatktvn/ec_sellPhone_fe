          ...
          if (product.category_name.toLocaleLowerCase() == 'điện thoại') {
            return (
              <tbody className='rounded-lg block overflow-hidden border-gray-300 border'>
                <tr className='bg-gray-200 p-2 flex'>
                  <td className='w-max block mr-5 font-bold'>
                    <span className=''>Kích thước màn hình</span>
                  </td>
                  <td>{product.specificationDTO.sizeScreen}</td>
                </tr>
                <tr className='p-2 flex'>
                  <td className='font-bold'>Công nghệ màn hình</td>
                  <td>{product.specificationDTO.screenTechnology}</td>
                </tr>
                <tr className='bg-gray-200 p-2 flex'>
                  <td className='font-bold'>Camera sau</td>
                  <td>{product.specificationDTO.cameraRear}</td>
                </tr>
                <tr className='p-2 flex'>
                  <td className='font-bold'>Camera trước</td>
