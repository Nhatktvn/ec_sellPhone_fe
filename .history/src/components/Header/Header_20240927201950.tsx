    ...
    <div className='bg-orange pt-3'>
      ...
      <div className='container mt-1'>
        <ul className='flex gap-4 text-white'>
          ...
          <li className='hover:bg-[#ff1630] hover:rounded-t-md transition-all duration-75 p-2 text-base cursor-pointer flex items-center gap-1'>
            <FaLaptop />
            Laptop
          </li>
          <li className='hover:bg-[#ff1630] hover:rounded-t-md transition-all duration-75 p-2 text-base cursor-pointer flex gap-1 items-center'>
            <FaHeadphonesAlt />
            Phụ kiện
          </li>
          <li className='hover:bg-[#ff1630] hover:rounded-t-md transition-all duration-75 p-2 text-base cursor-pointer flex gap-1 items-center'>
