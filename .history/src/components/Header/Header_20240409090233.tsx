          ...
          <div className='flex gap-2 items-center group'>
            ...
            {isAuthenticated ? (
              <div className='relative py-4 group'>
                ...
                <div className='w-max h-max bg-white absolute top-full z-0 left-1/2 -translate-x-1/2 rounded-md shadow-md text-base p-2 flex flex-col items-start group-hover:opacity-100 group-hover:z-10'>
