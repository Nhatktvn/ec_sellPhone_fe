    ...
    <div className='bg-orange pt-3'>
      ...
      <div className='container mt-1'>
        <ul className='flex gap-5 text-white'>
          <li className='hover:bg-slate-400 p-2 text-base cursor-pointer'>Điện thoại</li>
          <li className='hover:bg-slate-400 p-2 text-base cursor-pointer'>Laptop</li>
          <li className='hover:bg-[#ff1630] hover:rounded-t-md transition-all duration-75 p-2 text-base cursor-pointer'>
            Phụ kiện
          </li>
        </ul>
      </div>
