...
import bannerMainImg from '../../assets/iphone banner.png'
const BannerMain = () => {
  return (
    <div>
      <div className='relative'>
        <div
          ...
          // style={{
          //   height: '220px',
          //   background: `url(${bannerMainImg}) no-repeat`,
        ...
        <div className='w-full container relative md:absolute md:bottom-0 md:left-1/2 md:-translate-x-1/2 md:translate-y-1/2 px-0 mt-5 md:mt-0'>
          <SwiperMain />
        </div>
      ...
      <div className='w-full mt-5  md:mt-[130px] mb-5 container p-0 grid grid-cols-12 gap-5'>
        <div className='flex gap-2 items-center p-4 bg-white col-span-6 md:col-span-3 rounded-2xl justify-center'>
          <img
