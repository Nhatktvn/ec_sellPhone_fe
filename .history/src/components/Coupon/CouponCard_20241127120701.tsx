...
const CouponCard = ({ coupon }: props) => {
  return (
    <div className='max-w-md mx-auto p-6'>
      ...
      >
        <div className='p-6 border-2 border-dashed border-blue-500 rounded-2xl'>
          <div className='flex items-center justify-between mb-4'>
            ...
            <button
              ...
              className='flex items-center space-x-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-colors duration-200'
              aria-label='Copy coupon code'
            >
              <span className='font-mono font-bold'>{couponData.code}</span>
              <FaCopy />
            </button>
          </div>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <span className='font-semibold text-gray-700'>${couponData.minAmount}</span>
            </div>
            ...
            <div className='flex items-center justify-between'>
              ...
              <span className='font-semibold text-gray-700'>{formatDate(couponData.startDate)}</span>
            </div>
            ...
            <div className='flex items-center justify-between'>
              ...
              <span className='font-semibold text-gray-700'>{formatDate(couponData.endDate)}</span>
            </div>
          </div>
