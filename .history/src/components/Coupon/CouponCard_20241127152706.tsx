        ...
        <div className='p-6 border-2 border-dashed border-orange rounded-2xl'>
          <div className='flex items-center justify-between mb-4'>
            ...
            {isReceive ? (
              ...
              <button
                onClick={handleGetCouponByUser}
                className='flex items-center space-x-2 bg-gray-500 text-white px-4 py-3 rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-colors duration-200'
                aria-label='Copy coupon code'
              >
