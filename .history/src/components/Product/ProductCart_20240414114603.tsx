...
function ProductCart() {
  ...
  return (
    <Link
      ...
      className='col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-2 bg-white rounded-sm shadow-md mb-3 relative group'
    >
      <div className='bg-orange rounded-full text-white text-2xl w-max p-2 absolute top-2/3 -translate-y-full z-10 right-3 translate-x-14 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 duration-500 ease-out hover:opacity-80'>
        <TbCategoryPlus />
      </div>
