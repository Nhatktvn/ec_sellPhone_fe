function ProductCart() {
  return (
    <div className='col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-2 bg-white rounded-sm shadow-md '>
      <div>
        <img
      ...
      <div className='p-2'>
        ...
        <div className='rating-outer text-xs my-2 before:text-orange'>
          <div className='rating-inner w-[60%] before:text-orange'></div>
        </div>
