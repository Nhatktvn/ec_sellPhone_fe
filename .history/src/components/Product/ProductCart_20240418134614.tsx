...
function ProductCart({ product }: props) {
  ...
  return (
    <div className='col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-2 bg-white rounded-xl shadow-md mb-3 relative group overflow-hidden'>
      ...
      <div className='mt-2 overflow-hidden group'>
        <img className='group-hover:scale-110 duration-500 ease-out' src={product.images} alt='' />
      </div>
      <div className='p-2'>
