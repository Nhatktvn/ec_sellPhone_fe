...
function ProductCart({ product, className }: props) {
  ...
  return (
    <div
      className={`${className}  rounded-xl shadow-md mb-3 relative group overflow-hidden flex-col items-center justify-center bg-red-400 w-full`}
    >
