...
function ProductCart({ product, className }: props) {
  ...
  return (
    <div className={`${className} bg-white rounded-xl shadow-md mb-3 relative group overflow-hidden`}>
      ...
      <div
        className='bg-orange rounded-full text-white text-2xl w-max p-2 absolute top-2/3 -translate-y-full z-10 right-3 translate-x-14 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 duration-500 ease-out cursor-auto'
        title='Chọn sản phẩm'
