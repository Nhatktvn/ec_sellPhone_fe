...
const SearchAndFilter: React.FC<SearchAndFilterProps> = () => {
  ...
  useEffect(() => {
    handleFilterProduct()
  }, [selectedBrands, selectedCategory, searchTerm, priceRange, ram, rom])
                    ...
                    if (pageSelect == i + 1) {
                      return (
                        ...
                        >
                          <a
                            href='#'
                            className='flex items-center justify-center px-3 h-8 leading-tight text-blue-500 bg-white border border-blue-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white'
                          >
                            {i + 1}
                          </a>
                        </li>
