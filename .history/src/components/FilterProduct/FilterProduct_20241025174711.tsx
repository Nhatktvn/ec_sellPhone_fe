...
const SearchAndFilter: React.FC<SearchAndFilterProps> = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>('Điện thoại')
  ...
  const categories: Category[] = [
    { id: 'phones', name: 'Điện thoại', icon: <FaMobile /> },
    { id: 'laptops', name: 'Laptop', icon: <FaLaptop /> },
    { id: 'tablets', name: 'Tablet', icon: <FaTabletAlt /> },
    { id: 'accessories', name: 'Phụ kiện', icon: <FaHeadphones /> }
  ]

  const brands: string[] = ['Apple', 'Samsung', 'Google', 'OnePlus', 'Xiaomi', 'ASUS', 'Dell', 'HP']
