...
const Category: React.FC<categoryProps> = ({ category }) => {
  return (
    ...
    >
      <div className='w-full h-[120px] border-2 group-hover:shadow-lg transition duration-150 flex items-center rounded-xl overflow-hidden p-2 bg-white shadow-[0px 0px 5px 0px #e5e5e5]'>
        <div className=''>
          <img
            className=' block'
