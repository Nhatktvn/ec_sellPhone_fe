...
const Category: React.FC<categoryProps> = ({ category }) => {
  return (
    <div className='w-[120px]  flex flex-col justify-center items-center rounded-md overflow-hidden group cursor-pointer'>
      <div className='w-full h-[120px] border-2 border-ỏ group-hover:shadow-lg transition duration-150 flex items-center rounded-full overflow-hidden p-2 bg-white '>
        <div className=''>
          <img
            className=' block'
