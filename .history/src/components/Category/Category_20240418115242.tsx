...
const Category: React.FC<categoryProps> = ({ category }) => {
  return (
    ...
    >
      <div className='w-[120px] group-hover:shadow-cateHover transition duration-150 items-center rounded-xl overflow-hidden p-2 bg-white shadow-cate flex flex-col'>
        <div className=''>
          <img
            className=' block'
