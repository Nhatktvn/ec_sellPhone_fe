...
const AdminLayout: React.FC<Props> = ({ children, title }) => {
  ...
  return (
    <Layout className='relative'>
      ...
      >
        <div className='demo-logo-vertical mt-5 flex items-center gap-4 w-full justify-center'>
          <div className='w-10 h-10 bg-red-400'>
            <img src='' alt='' />
          </div>
          <h3 className={` w-max ${collapsed && 'w-0'} text-white duration-300`}>Welcome, Admin</h3>
        </div>
        <Menu
          theme='dark'
          mode='inline'
