      ...
      >
        ...
        >
          ...
          <Menu.Item key='2' icon={<BiCategory />}>
            <Link to='/admin/manage-category'>Quản lý danh mục</Link>
          </Menu.Item>
          <Menu.Item key='2' icon={<FaSitemap />}>
            <Link to='/admin/manage-product'>Quản lý sản phẩm</Link>
          </Menu.Item>
          <Menu.Item key='2' icon={<FaShoppingCart />}>
            <Link to='/admin/manage-order'>Quản lý đơn hàng</Link>
          </Menu.Item>
        </Menu>
      </Sider>
