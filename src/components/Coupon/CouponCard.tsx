        ...
        <div className='p-6 border-2 border-dashed border-orange rounded-2xl'>
          <div className='flex items-center justify-between mb-4'>
            ...
            {!isReceive ? (
              ...
              <button
                className='flex items-center space-x-2 bg-gray-500 text-white px-4 py-3 rounded-lg hover:bg-gray-600 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-colors duration-200'
                aria-label='Copy coupon code'
              >
                <span className='font-mono font-bold w-max'>Đã nhận</span>
                <FaCopy />
              </button>
            )}
          </div>
